...
where
    ...
    E: Endian,
{
    v1: ArchivedSlice<u32, P, E>,
    v2: ArchivedSlice<u16, P, E>,
}
...
where
    ...
    E: Endian,
{
    type DeserializedType<'a> = Inner;
}

impl<P, E> Deserialize for ArchivedInner<P, E>
where
    P: Pointer,
    E: Endian,
{
...
where
    ...
    E: Endian,
{
    type DeserializedType<'a> = NestedSlice;
}

impl<P, E> Deserialize for ArchivedNestedSlice<P, E>
where
    P: Pointer,
    E: Endian,
{
