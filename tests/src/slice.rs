...
impl PartialEq<Slice<'_>> for OwnedSlice {
...
where
    ...
    E: Endian,
{
    v1: archive::slice::ArchivedSlice<ArchivedPrimitive<u32, E>, P, E>,
    v2: archive::slice::ArchivedSlice<ArchivedPrimitive<u16, E>, P, E>,
}
...
where
    ...
    E: Endian,
{
    type DeserializedType = OwnedSlice;
